...
namespace Spajz
{
    public partial class EditorKorisnik : Form
    {
        int broj_sloga = 0;
        DataTable tabela;

        public EditorKorisnik()
        {
            InitializeComponent();
        }
        ...
        private void EditorKorisnik_Load_1(object sender, EventArgs e)
        {
            Load_Data();
            Txt_Load();
        }
        ...
        {
            StringBuilder Naredba = new StringBuilder("INSERT INTO Korisnik (ime, prezime, email, pass) VALUES ('");
